...
public class NW_SpawnPointsManager : NetworkBehaviour
{
    [SerializeField] private List<NW_SpawnPointFallingTrap> spawnPoints;
    ...
    {
        List<NW_SpawnPointFallingTrap> availablePoints = spawnPoints.FindAll(sp => !sp.IsOnCooldown);
